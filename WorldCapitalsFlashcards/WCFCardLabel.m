...
- (id)initWithText:(NSString *)text
{
    ...
    if (self) {
        ...
        [textLayer setBounds:CGRectMake(0.0, 0.0, 50.0, 30.0)];  // make the bounds width = the width of card
        // to center the text
        [textLayer setPosition:CGPointMake(40.0, 20.0)];  // In real life adjust it to center the text somehow
